...
const Upload = () => {
  ...
  const [dogDogGender, setDogGender] = useState("");
  const [dogDescription, setDogDescription] = useState("");
  const [dogNature, setDogNature] = useState("");
  const [dogCity, setDogCity] = useState("");
  const [dogState, setDogState] = useState("");
  const [dogAddress, setDogAddress] = useState("");
  const [dogLandmark, setDogLandmark] = useState("");
            ...
            <form class="space-y-4 md:space-y-6" action="#">
              <div>
                ...
                <input
                  type="submit"
                  value="submit"
                  className="  hover:bg-gray-400 flex  text-md justify-center items-center pb-1 bg-gray-200 px-2 rounded-md border border-gray-500  my-2 cursor-pointer"
                />
              </div>
              <div>
                <label
              ...
              <div>
                ...
                <input
                  ...
                  required=""
                  onChange={(event) => setDogNature(event.target.value)}
              ...
              <div>
                ...
                <input
                  ...
                  placeholder=""
                  required=""
                  onChange={(event) => setDogCity(event.target.value)}
              ...
              <div>
                ...
                <input
                  ...
                  placeholder=""
                  required=""
                  onChange={(event) => setDogLandmark(event.target.value)}
              ...
              <div>
                ...
                <input
                  ...
                  placeholder=""
                  required=""
                  onChange={(event) => setDogAddress(event.target.value)}
